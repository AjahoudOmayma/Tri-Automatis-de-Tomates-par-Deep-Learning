...
# Role: Integration of the trained YOLOv8 model into a Flask backend
# Features: image prediction API, webcam frame prediction API, JSON response with bounding boxes
